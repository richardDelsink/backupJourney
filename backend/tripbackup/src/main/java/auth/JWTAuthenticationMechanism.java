...
public class JWTAuthenticationMechanism implements HttpAuthenticationMechanism {
    ...
    public AuthenticationStatus validateRequest(HttpServletRequest req, HttpServletResponse res, HttpMessageContext context) throws AuthenticationException {
        ...
        if (credential != null) {
            ...
            if (req.getMethod().equals("OPTIONS") || req.getRequestURI().contains("websocket") || req.getRequestURI().contains("login") || req.getRequestURI().contains("register") || req.getRequestURI().contains("index.html")) {
